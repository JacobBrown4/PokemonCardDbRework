...
{
    /// <summary>
    /// Document filter for adding Authorization header in Swashbukle / Swagger.
    /// </summary>
    public class AddAuthorizationHeaderParameterOperationFilter : IOperationFilter
    {
        public void Apply(Operation operation, SchemaRegistry schemaRegistry, ApiDescription apiDescription)
        {
            ...
            var isAuthorized = filterPipeline
                .Select(filiterInfo => filiterInfo.Instance)
    ...
    /// Swagger normally won't find it - the /token endpoint - due to it being programmatically genersted.
    /// </summary>
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "PokemonCard.WebAPI");
